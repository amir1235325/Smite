...
const translations: Record<Language, Translations> = {
  en: {
    ...
    loadBalancers: {
      ...
      subtitle: 'Manage load balancers for tunnel distribution',
      ...
      tunnels: 'Tunnels',
      error: 'Error',
      loading: 'Loading load balancers...',
      noLoadBalancers: 'No load balancers found. Create one to get started.',
      selectIranNode: 'Select an Iran node',
      selectIranNodeFirst: 'Please select an Iran node first',
      noTunnels: 'No tunnels available for this Iran node',
      noTunnelsOnOtherNodes: 'No tunnels on other Iran nodes',
      confirmDelete: 'Are you sure you want to delete this load balancer?',
      deleteError: 'Failed to delete load balancer',
      saveError: 'Failed to save load balancer',
    },
    settings: {
      title: 'Settings',
  ...
  fa: {
    ...
    loadBalancers: {
      title: 'تعادل بار',
      subtitle: 'مدیریت تعادل بار برای توزیع تونل',
      create: 'ایجاد تعادل بار',
      edit: 'ویرایش تعادل بار',
      update: 'به‌روزرسانی',
      cancel: 'لغو',
      name: 'نام',
      iranNode: 'نود ایران',
      listenPort: 'پورت گوش‌دهی',
      algorithm: 'الگوریتم',
      tunnels: 'تونل‌ها',
      error: 'خطا',
      loading: 'در حال بارگذاری تعادل بار...',
      noLoadBalancers: 'تعادل باری یافت نشد. یکی ایجاد کنید.',
      selectIranNode: 'یک نود ایران انتخاب کنید',
      selectIranNodeFirst: 'لطفاً ابتدا یک نود ایران انتخاب کنید',
      noTunnels: 'تونلی برای این نود ایران موجود نیست',
      noTunnelsOnOtherNodes: 'تونلی روی نودهای دیگر ایران موجود نیست',
      confirmDelete: 'آیا از حذف این تعادل بار مطمئن هستید؟',
      deleteError: 'حذف تعادل بار ناموفق بود',
      saveError: 'ذخیره تعادل بار ناموفق بود',
    },
    settings: {
      title: 'تنظیمات',
